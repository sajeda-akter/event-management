...
const Footer = () => {
  ...
  <aside>
        <img src="https://i.ibb.co/9W2YPb5/logo1.jpg" className="w-16 h-16 rounded-full" alt="" />
    <p className="font-bold">
        <span className="text-2xl">Butterfly Wings</span> <br/>Providing reliable decoration event since 2010
    </p> 
